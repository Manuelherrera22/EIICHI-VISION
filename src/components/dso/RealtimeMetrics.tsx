    ...
    <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-bold text-gray-900">{t('metrics.realtime.title')}</h3>
            <p className="text-xs sm:text-sm text-gray-500">{t('metrics.realtime.subtitle')}</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium hidden sm:inline">{isLive ? t('metrics.realtime.live') : t('metrics.realtime.paused')}</span>
          </button>
          ...
          <button className="flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            ...
            <span className="text-xs sm:text-sm hidden sm:inline">{t('metrics.realtime.export')}</span>
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 mb-4 sm:mb-6">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs sm:text-sm text-gray-600">{t('metrics.timePeriod.period')}:</span>
        </div>
      ...
      {/* Tabs - Responsive */}
      <div className="flex overflow-x-auto scrollbar-hide mb-4 sm:mb-6 bg-gray-100 rounded-lg p-1">
      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-3 sm:p-4 border border-blue-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-blue-600 font-medium">{t('metrics.realtime.iviAverage')}</p>
                    <p className="text-xl sm:text-2xl font-bold text-blue-900">{analysis.investmentReadiness.score}%</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-3 sm:p-4 border border-green-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-green-600 font-medium">{t('metrics.realtime.ivmAverage')}</p>
                    <p className="text-xl sm:text-2xl font-bold text-green-900">{analysis.migrationReadiness.score}%</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-3 sm:p-4 border border-purple-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-purple-600 font-medium">{t('metrics.realtime.iseAverage')}</p>
                    <p className="text-xl sm:text-2xl font-bold text-purple-900">{analysis.lifestyleAlignment.score}%</p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-3 sm:p-4 border border-orange-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-orange-600 font-medium">{t('metrics.realtime.engagement')}</p>
                    <p className="text-xl sm:text-2xl font-bold text-orange-900">{analysis.engagementLevel}</p>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-gray-50 rounded-xl p-3 sm:p-4">
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">{t('metrics.realtime.performanceTrend')}</h4>
              ...
              {/* Pie Chart */}
              <div className="bg-gray-50 rounded-xl p-3 sm:p-4">
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">{t('metrics.realtime.metricsDistribution')}</h4>
                <ResponsiveContainer width="100%" height={250}>
                  <PieChart>
                    <Pie
                      data={pieData}
        ...
        {activeTab === 'trends' && (
          ...
          >
            ...
            <div className="bg-gray-50 rounded-xl p-3 sm:p-4">
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">{t('aiPredictions.temporalEvolution')}</h4>
        ...
        {activeTab === 'comparison' && (
          ...
          >
            ...
            <div className="bg-gray-50 rounded-xl p-3 sm:p-4">
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">{t('metrics.realtime.metricsComparison')}</h4>
              <ResponsiveContainer width="100%" height={300}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 sm:p-6 border border-blue-200">
                <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                  ...
                  <h4 className="text-base sm:text-lg font-semibold text-gray-900">{t('aiPredictions.title')}</h4>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs sm:text-sm text-green-600 font-medium">{t('aiPredictions.confidence', { confidence: String(87) })}</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 sm:p-6 border border-green-200">
                <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                  ...
                  <h4 className="text-base sm:text-lg font-semibold text-gray-900">{t('recommendations.title')}</h4>
                </div>
                <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs sm:text-sm text-blue-600 font-medium">{t('recommendations.priority', { priority: t('recommendations.priorityHigh') })}</span>
                </div>
              </div>
            </div>
          </motion.div>
