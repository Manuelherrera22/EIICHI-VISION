  ...
  const attractions = [
    {
      ...
      image: "/images/onsen.jpg?v=2", // Real Kusatsu Onsen
  ...
  return (
    <section className="py-16 sm:py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Gunma Heritage Section */}
        <div className="bg-gradient-to-br from-green-50 to-blue-50 p-8 rounded-2xl mb-16">
          <div className="text-center mb-8">
            <div className="inline-flex items-center bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium mb-4">
              <span className="mr-2">🏔️</span>
              DISCOVER THE HERITAGE OF GUNMA
            </div>
            <h3 className="text-3xl font-bold text-gray-900 mb-4">
              Japanese Tradition in the Heart of Gunma
            </h3>
            <p className="text-gray-700 max-w-3xl mx-auto mb-6">
              Gunma is a unique prefecture in Japan, where millenary tradition meets modernity. Its natural hot springs, majestic mountains and traditional architecture create an incomparable environment for living and investing.
            </p>
            <p className="text-gray-700 max-w-3xl mx-auto mb-8">
              Each property in Gunma tells a unique story. From traditional minka houses to centennial temples, these properties represent the authentic essence of Japan that many seek to experience.
            </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg mb-8">
              ...
              <div className="text-gray-600">- Gunma Heritage</div>
              <div className="text-sm text-gray-500 mt-2">伝統と未来の出会い</div>
            </div>
          </div>

          {/* Heritage Metrics */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 text-white p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-transform">
              <div className="text-center">
                ...
                <div className="text-yellow-200 text-sm mt-2">
                  Healing waters throughout the prefecture
                </div>
              </div>
            </div>
            
            <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-transform">
              <div className="text-center">
                <div className="text-5xl font-bold mb-4">2000+</div>
            ...
            <div className="bg-gradient-to-br from-green-500 to-green-600 text-white p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-transform">
              <div className="text-center">
                ...
                <div className="text-green-200 text-sm mt-2">
                  Endless landscapes and scenery
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <button className="inline-flex items-center space-x-2 bg-primary text-black px-6 py-3 rounded-full font-semibold text-lg hover:bg-primary/90 transition-colors">
