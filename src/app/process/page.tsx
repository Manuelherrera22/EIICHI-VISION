                  ...
                  <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                    <div className="relative h-80 rounded-2xl overflow-hidden shadow-2xl">
                      ...
                      <div className={`absolute inset-0 bg-cover bg-center bg-no-repeat opacity-60 ${
                        step.number === 1 
                          ? "bg-[url('/images/geoff-oliver-6KNPp4ifLn4-unsplash.jpg')]" // Beautiful Japanese countryside discovery
                          : step.number === 2
                          ? "bg-[url('/images/cheung-gnaiq-GXXSL9dkwis-unsplash.jpg')]" // Traditional Japanese house acquisition
                          : step.number === 3
                          ? "bg-[url('/images/ikarovski-rld1TAi9gpc-unsplash.jpg')]" // Modern Japanese architecture/renovation
                          : "bg-[url('/images/kouji-tsuru-TSzPcfyZd_M-unsplash.jpg')]" // Traditional Japanese onsen community
                      }`}></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 bg-[url('/images/nobey-noh-1HB6IjYeO4Y-unsplash.jpg')] bg-cover bg-center bg-no-repeat opacity-80"></div>
              </div>
            </div>
          </div>
        </div>
