  ...
  const sections = [
    {
      ...
      content: [
        ...
        'Información de la propiedad de interés',
        'Preferencias de comunicación',
        'Datos de navegación y uso del sitio web',
        'Información financiera necesaria para transacciones'
      ]
    },
    {
      icon: Database,
          ...
          <div className="space-y-12">
            ...
            <div className="bg-gradient-to-r from-primary to-primary/80 text-white rounded-2xl p-8">
              ...
              <div className="space-y-2 text-white/90">
                <p><strong>Email:</strong> privacy@komorebihouse.com</p>
                <p><strong>Teléfono:</strong> +81 90-1234-5678</p>
                <p><strong>Dirección:</strong> Kusatsu, Gunma, Japan</p>
              </div>
            </div>
